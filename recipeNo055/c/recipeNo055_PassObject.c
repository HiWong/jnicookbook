#include <stdio.h>
#include "jni.h"
#include "recipeNo055_PassObject.h"
...
JNIEXPORT void JNICALL Java_recipeNo055_PassObject_passBoolean
...
JNIEXPORT void JNICALL Java_recipeNo055_PassObject_passByte
  (JNIEnv * env, jclass obj, jobject objarg) {
...
JNIEXPORT void JNICALL Java_recipeNo055_PassObject_passCharacter
  (JNIEnv * env, jclass obj, jobject objarg) {
...
JNIEXPORT void JNICALL Java_recipeNo055_PassObject_passFloat
  (JNIEnv * env, jclass obj, jobject objarg) {
...
JNIEXPORT void JNICALL Java_recipeNo055_PassObject_passLong
  (JNIEnv * env, jclass obj, jobject objarg) {
...
JNIEXPORT void JNICALL Java_recipeNo055_PassObject_passShort
  (JNIEnv * env, jclass obj, jobject objarg) {
...
JNIEXPORT void JNICALL Java_recipeNo055_PassObject_passDouble
  (JNIEnv * env, jclass obj, jobject objarg) {
