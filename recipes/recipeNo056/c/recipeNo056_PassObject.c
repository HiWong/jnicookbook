#include <stdio.h>
#include "jni.h"
#include "recipeNo056_PassObject.h"
...
JNIEXPORT void JNICALL Java_recipeNo056_PassObject_passBoxedValue
  (JNIEnv * env, jclass obj, jobject objarg) {

  jclass cls = (*env)->GetObjectClass (env, objarg);

  if( (*env)->IsInstanceOf(env, objarg, (*env)->FindClass(env, "java/lang/Boolean")) ) {
    ...
    printf("%-22s: %s\n", "Passed value (boolean)", result == JNI_TRUE ? "true" : "false");

  } else if( (*env)->IsInstanceOf(env, objarg, (*env)->FindClass(env, "java/lang/Byte")) ) {
  ...
  } else if( (*env)->IsInstanceOf(env, objarg, (*env)->FindClass(env, "java/lang/Character")) ) {
  ...
  } else if( (*env)->IsInstanceOf(env, objarg, (*env)->FindClass(env, "java/lang/Float")) ) {
  ...
  } else if( (*env)->IsInstanceOf(env, objarg, (*env)->FindClass(env, "java/lang/Integer")) ) {
  ...
  } else if( (*env)->IsInstanceOf(env, objarg, (*env)->FindClass(env, "java/lang/Long")) ) {
  ...
  } else if( (*env)->IsInstanceOf(env, objarg, (*env)->FindClass(env, "java/lang/Short")) ) {
  ...
  } else if( (*env)->IsInstanceOf(env, objarg, (*env)->FindClass(env, "java/lang/Double")) ) {
