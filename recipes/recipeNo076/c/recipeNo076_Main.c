...
#include <string.h>
#include <sys/errno.h>
#include "recipeNo076_Main.h"

JNIEXPORT jobject JNICALL Java_recipeNo076_Main_buildObject
  ...
  jclass    wCls                 = (*env)->FindClass( env, "recipeNo076/Wrapper" );
  jmethodID wConstructorID       = (*env)->GetMethodID( env, wCls, "<init>", "()V" );
  jmethodID setIntValMethodID    = (*env)->GetMethodID( env, wCls, "setIntVal", "(I)V" );
  ...
  (*env)->CallVoidMethod(env, wObj, setStringValMethodID, (*env)->NewStringUTF( env, str ) );
